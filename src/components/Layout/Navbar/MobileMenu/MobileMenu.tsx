...
export const MobileMenu: React.FC<MobileMenuProps> = ({ links, handleHref, onClose }) => (
  <div className="mx-3 w-full md:hidden" id="mobile-menu">
    <ul className="mt-4 flex flex-col space-y-4 divide-y divide-gray-200 rounded-lg border border-gray-100 bg-white p-4 md:dark:divide-[#FFFFFF] md:dark:border-[#FFFFFF] md:dark:bg-[#18171e]">
