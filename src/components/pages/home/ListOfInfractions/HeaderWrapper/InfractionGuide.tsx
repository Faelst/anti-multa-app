...
const InfractionGuide: React.FC = () => {
  ...
  const colorIcon = isDark ? '#FFFFFFB2' : '#000000';

  return (
    <div className="flex flex-col justify-start space-y-2 p-4">
      <div className="flex items-center gap-2">
        <AiOutlineFileSearch size={30} className="text-gray-900 md:dark:text-[#FFFFFFB2]" />
      ...
      <p className="text-xs text-gray-500 sm:text-sm md:dark:text-[#FFFFFFB2]">
